...
export class APIService {
  ...
  async DeleteRoomBooking(
  ...
  ): Promise<DeleteRoomBookingMutation> {
    const statement = `mutation DeleteRoomBooking($input: DeleteRoomInput!) {
        deleteRoomBooking(input: $input) {
          __typename
          roomId
          buildingId
          name
    ...
    return <DeleteRoomBookingMutation>response.data.deleteRoomBooking;
  }
